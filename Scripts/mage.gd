...
@export var max_hitpoints: float = 1000
...
var magic_explosion_scene: PackedScene = preload("res://Instances/smaller_magic_explosion.tscn")
...
func casting_magic() -> void:
	...
	magic_explosion.global_position = global_position + Vector2(-192, -32)
